...
void main() {
  ...
  testWidgets(
    'CycleInlineCalendar uses full available width',
    (tester) async {
  ...
  testWidgets(
    'CycleInlineCalendar today pill has full opacity phase color',
    (tester) async {
      final today = DateTime(2025, 9, 28);
      final cycleInfo = CycleInfo(
        lastPeriod: DateTime(2025, 9, 19),
      ...
      expect(
        ...
        reason: 'Today pill should use full follicularDark color for follicular phase',
      );
  ...
  testWidgets(
    ...
    (tester) async {
      ...
      final today = DateTime(2025, 9, 15); // Ovulation day for 28-day cycle starting Sep 1
      final cycleInfo = CycleInfo(
  ...
  testWidgets(
    'CycleInlineCalendar segment colors match medical phase tokens',
    (tester) async {
