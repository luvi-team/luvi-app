...
void main() {
  ...
  testWidgets('option tap enables CTA and navigates', (tester) async {
    final router = GoRouter(
      routes: [
        GoRoute(path: Onboarding05Screen.routeName, builder: (context, state) => const Onboarding05Screen()),
        GoRoute(path: '/onboarding/06', builder: (context, state) => const Scaffold(body: Text('Onboarding 06 (Stub)'))),
      ],
    ...
    final firstOption = find.textContaining('Weniger als 3 Tage'); // an Figma-Text anpassen
