...
void main() {
  testWidgets('W3 content renders headline and Weiter button (asset-free)', (tester) async {
        ...
        title: RichText(
          ...
          text: TextSpan(
            ...
            children: [
              ...
              TextSpan(text: 'Körper', style: theme.textTheme.headlineMedium?.copyWith(color: theme.colorScheme.primary)),
    ...
    expect(find.byWidgetPredicate((w) => w is RichText && w.text.toPlainText().contains('Endlich verstehen, was dein')), findsOneWidget);
