...
Status: Accepted  
Datum: 2025-11-05  
Änderung (2025‑11‑08): Schwellen konsistent angepasst: SEV‑1 ≥ 5 000 und SEV‑2 ≥ 3 000 betroffene Nutzer/Tag; SEV‑1 enthält qualitative Trigger (Datenkorruptionssignale). Runbook‑Konformität hergestellt.
...
- Monitoring & Alerts:
  ...
  - Schwellwerte & Eskalation:
    ...
    - SEV‑2: ≥ 10 % über ≥ 30 min ODER ≥ 3 000 betroffene Nutzer/Tag → Incident Commander, dedizierter Channel.
    - SEV‑1: ≥ 15 % über ≥ 15 min ODER ≥ 5 000 betroffene Nutzer/Tag ODER Datenkorruptionssignale → globaler Write‑Stopp für Snapshots, Feature‑Flag „local‑only“ aktivieren.
