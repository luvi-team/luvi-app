...
| Rolle | Dossier | Haupt-Hand-off |
|---|---|---|
| ui-frontend | context/agents/01-ui-frontend.md | an api-backend (PR + tests/docs) |
| qa-dsgvo | context/agents/05-qa-dsgvo.md | an db-admin/ui-frontend (docs/privacy/reviews) |
| db-admin | context/agents/03-db-admin.md | an api-backend (migrations + docs) |
| dataviz | context/agents/04-dataviz.md | an ui-frontend (docs + PR) |
| api-backend | context/agents/02-api-backend.md | an ui-frontend/db-admin (docs + functions) |
