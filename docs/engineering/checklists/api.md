...
- Schema‑Validation (Request/Response) für Kernrouten (Test: api/__tests__/health.test.ts::"returns 200 OK with correct body"; ADR: ADR-0004 §Rollout; Runbook: docs/runbooks/test-edge-function-locally.md).
