...
- Erfolgskriterien – rollen-spezifisch gem. DoD (UI/DataViz inkl. Flutter-Tests; Backend/DB/QA ohne Flutter-Tests) · RLS/Consent (falls relevant) ✅ · Sentry/PostHog Smoke (UI) ✅ · CodeRabbit ✅
