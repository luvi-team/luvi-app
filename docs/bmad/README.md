...
für mich selbst, für Agents (Codex, Claude Code, GPT) und für
...
- **6. Referenzen**  
  Roadmap-Sprint, Use-Cases, Screen-Contracts, Dossiers, ADRs, DoD/Checklisten.
...
Codex, Claude Code und andere Agents.

---

## 4. BMAD im Alltag mit Codex & Claude Code nutzen

### 4.1 Codex (Backend + Review)
