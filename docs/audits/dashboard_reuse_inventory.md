...
| `_onSurface` (`#030401`) | `lib/core/theme/app_theme.dart:17` | `lib/features/onboarding/screens/onboarding_03.dart:99` nutzt `colorScheme.onSurface` für den Headline-Text | niedrig |
...
| `DsTokens.cardSurface` (`#F7F7F8`) | `lib/core/theme/app_theme.dart:149` | `lib/features/onboarding/widgets/goal_card.dart:50` färbt Karten-Hintergrund | niedrig |
| `DsTokens.cardBorderSelected` (`#1C1411`) | `lib/core/theme/app_theme.dart:150` | `lib/features/onboarding/widgets/goal_card.dart:54` setzt ausgewählten Rahmen | niedrig |
...
| `OpacityTokens.inactive` (`0.2`) | `lib/core/design_tokens/opacity.dart:3` | `lib/features/onboarding/screens/onboarding_01.dart:168` blendet Divider ab | niedrig |
...
| Name | Pfad | Evidence | Kollisionsrisiko |
| --- | --- | --- | --- |
| `Spacing.l` (`24`) | `lib/core/design_tokens/spacing.dart:2` | `lib/features/onboarding/screens/onboarding_01.dart:66` nutzt Abstand über dem Header | niedrig |
| `Spacing.m` (`16`) | `lib/core/design_tokens/spacing.dart:3` | `lib/features/onboarding/widgets/goal_card.dart:46` setzt horizontales Padding | niedrig |
| `Spacing.s` (`12`) | `lib/core/design_tokens/spacing.dart:4` | `lib/features/onboarding/widgets/goal_card.dart:82` nutzt Abstand vor dem Auswahlindikator | niedrig |
...
| `Spacing.goalCardVertical` (`20`) | `lib/core/design_tokens/spacing.dart:6` | `lib/features/onboarding/widgets/goal_card.dart:47` legt vertikales Padding fest | mittel |
| `Spacing.goalCardIconGap` (`20`) | `lib/core/design_tokens/spacing.dart:7` | `lib/features/onboarding/widgets/goal_card.dart:70` erzeugt Icon-Text-Abstand | mittel |
| `OnboardingSpacing.cardGap` (`24`) | `lib/core/design_tokens/onboarding_spacing.dart:216` | `lib/features/onboarding/screens/onboarding_03.dart:162` nutzt den Wert für Karten-Stacks | hoch |
| `OnboardingSpacing.headerToFirstCard` (`62`) | `lib/core/design_tokens/onboarding_spacing.dart:170` | `lib/features/onboarding/screens/onboarding_03.dart:60` positioniert Kopfbereich | hoch |
| `OnboardingSpacing.optionGap05` (`24`) | `lib/core/design_tokens/onboarding_spacing.dart:150` | `lib/features/onboarding/screens/onboarding_05.dart:131` trennt Optionen | hoch |
...
| `kOnboardingPickerHeight` (`198`) | `lib/features/onboarding/utils/onboarding_constants.dart:2` | `lib/features/onboarding/screens/onboarding_02.dart:255` dimensioniert Picker-Stack | mittel |
...
| `Sizes.radiusL` (`20`) | `lib/core/design_tokens/sizes.dart:4` | `lib/features/onboarding/widgets/goal_card.dart:43` definiert Karten-Rundung | niedrig |
...
| `_textThemeConst.bodyMedium` (Figtree 20/24) | `lib/core/theme/app_theme.dart:32` | `lib/features/onboarding/widgets/goal_card.dart:75` verwendet Kopie | niedrig |
| `_textThemeConst.bodySmall` (Inter 14/24) | `lib/core/theme/app_theme.dart:48` | `lib/features/onboarding/screens/onboarding_03.dart:110` nutzt Step-Typo | mittel (Font-Mismatch zu Dashboard) |
| `TypographyTokens.*` (14,16,20,24,32 + Ratios) | `lib/core/design_tokens/typography.dart:5` | `lib/features/onboarding/widgets/goal_card.dart:76` nutzt `size16`/`24on16` | niedrig |
...
| --- | --- | --- | --- | --- |
| `GoalCard` | `lib/features/onboarding/widgets/goal_card.dart:17` | `icon?`, `title`, `selected`, `onTap` | Empfehlungskarte (teilweise – kein Bild/CTA/Progress) | `lib/features/onboarding/screens/onboarding_03.dart:164`, `lib/features/onboarding/screens/onboarding_05.dart:133` |
...
| `CustomRadioCheck` | `lib/features/onboarding/widgets/custom_radio_check.dart:9` | `selected` (bool) | Kategorie-Chip (teilweise – kann als Status-Indikator dienen) | `lib/features/onboarding/widgets/goal_card.dart:83` |

### Buttons & CTA
| Name | Pfad | Props/States | Eignung | Evidence |
| --- | --- | --- | --- | --- |
| `BackButtonCircle` | `lib/core/widgets/back_button.dart:5` | `onPressed`, `size`, `innerSize?`, `backgroundColor?`, `iconColor?`, `isCircular`, `iconSize`; fester Chevron | SectionHeader (teilweise – Icon fix, keine Slot-Icons) | `lib/features/onboarding/screens/onboarding_02.dart:111` |
...
| Onboarding-Zielliste (`Column` + `List.generate`) | `lib/features/onboarding/screens/onboarding_03.dart:157` | `spacing.cardGap` (24) + `spacing.lastCardToCta` | `GoalCard` nutzt Radius 20, keine Schatten | Eignet sich für gridartige Stapel, aber ohne Bildinhalt |
...
| Scroll + Bottom-Picker (`Stack` mit `Positioned`) | `lib/features/onboarding/screens/onboarding_02.dart:73` & `:248` | Scroll-Padding `spacing.ctaToPicker`, Picker-Höhe `kOnboardingPickerHeight` | kein Shadow; Divider nutzt `OpacityTokens.inactive` | Muster für sticky Bottom-Elemente, nur vertikale Variante |
