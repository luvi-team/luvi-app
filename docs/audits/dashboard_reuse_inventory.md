...
| --- | --- | --- | --- | --- |
| `GoalCard` | `lib/features/widgets/goal_card.dart:17` | `icon?`, `title`, `selected`, `onTap` | Empfehlungskarte (teilweise – kein Bild/CTA/Progress) | `lib/features/onboarding/screens/onboarding_03.dart:164`, `lib/features/onboarding/screens/onboarding_05.dart:133` |
...
| Name | Pfad | Props/States | Eignung | Evidence |
| --- | --- | --- | --- | --- |
| `BackButtonCircle` | `lib/features/widgets/back_button.dart:5` | `onPressed`, `size`, `innerSize?`, `backgroundColor?`, `iconColor?`, `isCircular`, `iconSize`; fester Chevron | SectionHeader (teilweise – Icon fix, keine Slot-Icons) | `lib/features/onboarding/screens/onboarding_02.dart:111` |
