...
| `lib/features/onboarding/utils/onboarding_constants.dart:2` | Picker-Höhen & Min/Max-Daten außerhalb `lib/core/design_tokens/` | `Onboarding02Screen` (`lib/features/onboarding/screens/onboarding_02.dart:255`), `Onboarding04Screen` (`lib/features/onboarding/screens/onboarding_04.dart:76`) |
...
| `lib/core/theme/app_theme.dart:9` | Farb-Konstanten bleiben private Theme-Werte (`_primary`, `_accentSubtle`) statt ausgelagerter Farb-Tokens | Alle Komponenten via `Theme.of` (`GoalCard` `lib/features/onboarding/widgets/goal_card.dart:50`, `LoginCtaSection` `lib/features/auth/widgets/login_cta_section.dart:33`) |
