...
- Delegates: `MaterialApp.router` in `lib/main.dart` registriert `GlobalMaterialLocalizations.delegate`, `GlobalWidgetsLocalizations.delegate` und `GlobalCupertinoLocalizations.delegate` (Stand: 2025-10-01).
